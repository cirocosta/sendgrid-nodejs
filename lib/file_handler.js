 ...
 * @param  {object}  file_object              Options to create a
 *                                            FileHandler
 * @param  {string}  file_object.filename     The name of the file to
 *                                            send. This will be guessed
 *                                            based on the file added if
 *                                            blank.
 * @param  {string}  file_object.contentType  The Content-Type of the
 *                                            file.
 * @param  {string}  file_object.content      The content to send in
 *                                            the file (usually a
 *                                            Buffer)
 * @param  {string}  file_object.cid          The cid to use for
 *                                            inline content
 * @param  {string}  file_object.path         The absolute path of the
 *                                            file on the filesystem
 * @param  {string}  file_object.url          The url to fetch a file
 *                                            from before sending
 */
...
FileHandler.handlers = {
  ...
  url: function(file, callback) {
    ...
    var req = http.request({host: host, path: path, method: 'GET'},
                           function(res) {
