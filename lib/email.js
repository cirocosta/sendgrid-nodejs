 ...
 * @param  {Object}          params
 * @param  {string|array}    params.to       The to address(es) of the
 *                                           email
 * @param  {string|array}    params.toname   The display name of the
 *                                           email recipients
 * @param  {string}          params.from     The from address of the
 *                                           email
 * @param  {string}          params.fromname The display name of the
 *                                           email sender
 * @param  {SmtpapiHeaders}  params.smtpapi  The SendGrid x-smtpapi
 *                                           headers object
 * @param  {string}          params.subject  The subject of the email
 * @param  {string}          params.text     The text/plain content of
 *                                           an email
 * @param  {string}          params.html     The text/html content of
 *                                           an email
 * @param  {string|array}    params.bcc      The bcc address(es) of
 *                                           the email
 * @param  {Date}            params.date     The date of the email
 * @param  {object}          params.headers  The custom headers on an
 *                                           email
 */
